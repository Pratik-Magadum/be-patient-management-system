...
--changeset owner-pratik:12032026120000_insert_patient_dashboard_demo_data
--comment: Insert demo patients and appointments for patient dashboard testing

-- ============================================================================
-- Patients for Apollo Eye Hospital (hospital_id = a0eebc99-...)
-- ============================================================================
INSERT INTO patients (patient_id, hospital_id, patient_number, full_name, mobile_number, email, date_of_birth, address)
VALUES
    ('d1aab001-1111-4aaa-b111-000000000001', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PT-2026-00001', 'Amit Patel', '+91-9876543001', 'amit.patel@email.com', '1985-06-15', '12 MG Road, Mumbai'),
    ('d1aab001-1111-4aaa-b111-000000000002', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PT-2026-00002', 'Sunita Devi', '+91-9876543002', 'sunita.devi@email.com', '1990-03-22', '45 Park Street, Mumbai'),
    ('d1aab001-1111-4aaa-b111-000000000003', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PT-2026-00003', 'Rajesh Sharma', '+91-9876543003', 'rajesh.sharma@email.com', '1978-11-10', '78 Lal Bagh, Mumbai'),
    ('d1aab001-1111-4aaa-b111-000000000004', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PT-2026-00004', 'Meena Kumari', '+91-9876543004', 'meena.kumari@email.com', '1995-01-30', '23 Anna Nagar, Mumbai'),
    ('d1aab001-1111-4aaa-b111-000000000005', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PT-2026-00005', 'Vikram Singh', '+91-9876543005', 'vikram.singh@email.com', '1982-09-05', '56 Civil Lines, Mumbai'),
    ('d1aab001-1111-4aaa-b111-000000000006', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PT-2026-00006', 'Priya Nair', '+91-9876543006', 'priya.nair@email.com', '1992-07-18', '89 Marine Drive, Mumbai'),
    ('d1aab001-1111-4aaa-b111-000000000007', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PT-2026-00007', 'Ravi Verma', '+91-9876543007', 'ravi.verma@email.com', '1988-12-25', '34 Juhu Beach, Mumbai'),
    ('d1aab001-1111-4aaa-b111-000000000008', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PT-2026-00008', 'Anita Desai', '+91-9876543008', 'anita.desai@email.com', '1975-04-12', '67 Bandra West, Mumbai'),
    ('d1aab001-1111-4aaa-b111-000000000009', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PT-2026-00009', 'Suresh Reddy', '+91-9876543009', 'suresh.reddy@email.com', '1998-08-20', '90 Worli Sea Face, Mumbai'),
    ('d1aab001-1111-4aaa-b111-000000000010', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PT-2026-00010', 'Kavita Joshi', '+91-9876543010', 'kavita.joshi@email.com', '1980-02-14', '12 Powai Lake, Mumbai');

-- ============================================================================
-- Today's Appointments for Apollo Eye Hospital
...
-- ============================================================================
-- Expected Dashboard Results for Apollo Eye Hospital (today):
